...
**Nombre público**: **DataRights for WooCommerce** (rebranding 2026-08-22 por política de marcas WP.org: término "woo" restringido; slug futuro del directorio: `datarights-for-woocommerce`, verificado libre)
**Nombre interno/legado**: WooPrivacy FREE — clases `wooprivacy_*`/`Chilean_DP_*`, option keys `chilean_dp_*`, text domain y slug técnico `chilean-data-protection` permanecen intactos (no refactorizar sin decisión mayor)
**Público objetivo**: Chile (Ley 21.719) · **Relación plataforma**: extensión "for WooCommerce", no producto oficial
**Marca PRO separada**: las notas upgrade-path hoy dicen "la versión PRO" genérico — alineación de nombre PRO pendiente en su propio proyecto
