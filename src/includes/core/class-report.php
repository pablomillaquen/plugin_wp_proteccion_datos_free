...
class Chilean_DP_Report {
    ...
    private function html_document( array $d ): void {
        ...
        // FREE-015 T6 — CSS del reporte vía API oficial de estilos de WordPress.
        // wp_print_styles() imprime el <style> directamente en el punto de salida; no se captura
        // su resultado en una variable intermedia ni se re-imprime con echo. El CSS se registra,
        // encola y añade con la API de estilos (handle sin archivo, src=false), y el documento
        // descargado sigue siendo standalone/offline.
...
<?php wp_print_styles( 'datarights-report-standalone' ); ?></head><body>
